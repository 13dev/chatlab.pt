    ...
    <nav class="navigation">
        <div class="nav-group">
            <ul>
                ...
                <li>
                    <a class="active" data-navigation-target="chats" @click.prevent="handleChangeSidebar(1)" href="#"
                ...
                <li>
                    <a data-navigation-target="friends" href="#" data-toggle="tooltip"
                       @click.prevent="handleChangeSidebar(2)"
                ...
                <li>
                    <a data-navigation-target="favorites" data-toggle="tooltip" title="Favorites" data-placement="right"
                       @click.prevent="handleChangeSidebar(3)"
                       href="#">
                ...
                <li class="brackets">
                    <a data-navigation-target="archived" href="#" data-toggle="tooltip"
                       @click.prevent="handleChangeSidebar(4)"
...
export default {
    ...
    created() {
        // true -> light
        // false -> dark
        // obter valor da variavel mode do localstorage, se nao existe: true,
    },
    methods: {
        changeMode() {
            this.mode = !this.mode;
